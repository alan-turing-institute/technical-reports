...
(report
 ...
 (ack      "This work was supported in part through computational resources provided by The Alan Turing Institute under EPSRC grant EP/N510129/1 and with the help of a generous gift from Microsoft Corporation.")
 (date     (2025 07))
 (doi      "10.5281/zenodo.14615071")
 (keywords "Azure" "Cloud services" "Subscription management"))
...
;	    ("Jonathan Carter" (orcid "0000-0002-1500-662X"))
	    ...
	    ("Andrew Duncan" (orcid "0000-0001-5762-164X"))
	    ))
 (date     (2025 07))
 (doi      "10.5281/zenodo.16408412")
 (keywords "Test time scaling" "Reasoning models" "Large language models" "Retrieval augmented generation"))
...
(report
 ...
 (keywords "Accelerated compute" "Benchmarking" "High-performance computing" "Aurora" "GPUs"))
